...
public class Unclimbing extends Command {
  ...
  public void initialize() {
    RobotContainer.stateMachineInstance.setRobotState(RobotState.UNCLIMBING);
    RobotContainer.positionalInstance.setClimberPosition(ConstPositional.DEPLOY_CLIMBER_DISTANCE,
